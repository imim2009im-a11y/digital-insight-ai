...
export default function Home() {
  ...
  return <div dir="rtl" className="min-h-screen bg-[#151514] text-[#f4efe7] selection:bg-[#e8753a] selection:text-[#151514]">
    <div className="pointer-events-none fixed inset-0 opacity-[0.045] mix-blend-screen" style={{ backgroundImage: "url('/manus-storage/ai-tools-pattern_43cfa811.png')", backgroundSize: "700px auto" }} />
    <header className="relative z-10 border-b border-white/10 bg-[#151514]/85 backdrop-blur-xl">
      <div className="mx-auto flex max-w-[1440px] items-center justify-between px-5 py-4 lg:px-10">
        <a href="#top" className="group flex items-center gap-3" aria-label="دليل الأدوات - البداية">
          <img src="/manus-storage/ai-tools-logo_dfcf5f40.png" alt="" className="h-9 w-9 rounded-full object-contain" />
          <span className="font-display text-lg font-bold tracking-tight">دليل <span className="text-[#e8753a]">الأدوات</span></span>
        </a>
    ...
    <main id="top" className="relative z-10">
      <section className="relative isolate overflow-hidden border-b border-white/10">
        <img src="/manus-storage/ai-tools-hero_159ba617.png" alt="" className="absolute inset-0 -z-20 h-full w-full object-cover opacity-45" />
        ...
        <div className="mx-auto grid min-h-[590px] max-w-[1440px] items-end gap-12 px-5 pb-16 pt-24 lg:grid-cols-[1fr_0.7fr] lg:px-10 lg:pb-24">
          <div className="max-w-3xl">
            <div className="mb-7 flex items-center gap-3 text-sm font-medium text-[#e8753a]"><span className="h-px w-10 bg-[#e8753a]" /> فهرس عملي للإنترنت المفيد</div>
            <h1 className="font-display max-w-4xl text-5xl font-extrabold leading-[1.05] tracking-[-0.04em] text-[#f4efe7] sm:text-7xl lg:text-[92px]">لا تبحث<br /><span className="text-[#e8753a]">من الصفر.</span></h1>
            <p className="mt-8 max-w-xl text-lg leading-9 text-[#c9c2b9]">مجموعة منتقاة من الأدوات التي تختصر عليك ساعات من العمل. ابحث حسب المهمة، جرّب بوعي، واحتفظ بما يفيدك.</p>
            <div className="mt-10 flex flex-wrap gap-3"><a href="#directory" className="group inline-flex items-center gap-3 bg-[#e8753a] px-5 py-3 text-sm font-bold text-[#151514] transition-transform duration-200 hover:-translate-y-0.5 active:scale-[.97]">تصفح الفهرس <ArrowUpLeft size={17} className="transition-transform group-hover:-translate-x-1 group-hover:-translate-y-1" /></a><button onClick={() => { setShowSaved(true); document.getElementById("directory")?.scrollIntoView({ behavior: "smooth" }); }} className="inline-flex items-center gap-3 border border-white/20 px-5 py-3 text-sm font-bold text-[#f4efe7] transition-colors hover:border-[#e8753a] hover:text-[#e8753a]"><Bookmark size={17} /> المحفوظات ({saved.length})</button></div>
          </div>
          <div className="hidden justify-self-end lg:block"><div className="border border-white/15 bg-[#151514]/70 p-5 backdrop-blur-md"><div className="mb-12 flex items-center justify-between gap-24 text-[11px] uppercase tracking-[.22em] text-[#8d8983]"><span>Directory / 01</span><span>2026</span></div><div className="flex items-end gap-4"><span className="font-display text-8xl font-extrabold leading-none text-[#e8753a]">{tools.length}</span><span className="mb-2 max-w-[100px] text-sm leading-5 text-[#c9c2b9]">أداة وموقع<br />جاهز للاكتشاف</span></div><div className="mt-6 h-px w-full bg-white/15" /><div className="mt-4 flex items-center gap-2 text-xs text-[#8d8983]"><Sparkles size={13} className="text-[#e8753a]" /> أدوات عملية، دون ضجيج</div></div></div>
        </div>
      </section>

      <section id="directory" className="mx-auto max-w-[1440px] px-5 py-16 lg:px-10 lg:py-24">
        <div className="mb-10 flex flex-col justify-between gap-6 border-b border-white/10 pb-8 lg:flex-row lg:items-end"><div><p className="mb-3 text-xs font-bold uppercase tracking-[.24em] text-[#e8753a]">/ الفهرس</p><h2 className="font-display text-4xl font-bold tracking-tight sm:text-5xl">اختر مهمتك، لا أداتك</h2></div><p className="max-w-md text-sm leading-7 text-[#9c968e]">كل بطاقة تقودك إلى الموقع مباشرة. راجع شروط الاستخدام والخصوصية قبل رفع ملفاتك أو مشاركة بياناتك.</p></div>
      ...
      <section id="method" className="border-t border-white/10 bg-[#1b1b19]"><div className="mx-auto grid max-w-[1440px] gap-10 px-5 py-16 lg:grid-cols-[.8fr_1.2fr] lg:px-10 lg:py-20"><div><p className="mb-3 text-xs font-bold uppercase tracking-[.24em] text-[#e8753a]">/ ملاحظة تحريرية</p><h2 className="font-display max-w-md text-4xl font-bold leading-tight">الأداة الجيدة ليست دائمًا الأكثر شهرة.</h2></div><div className="max-w-2xl text-[#aaa39b]"><p className="text-lg leading-9">هذا الدليل يجمع أدوات من مجالات مختلفة، لكن وجودها هنا لا يعني أنها مناسبة لكل استخدام. لا ترفع بيانات حساسة إلى خدمة لا تثق بها، وتحقق من حقوق المحتوى قبل التنزيل أو إعادة الاستخدام.</p><div className="mt-8 flex flex-wrap gap-6 text-sm"><span className="flex items-center gap-2 text-[#f4efe7]"><Check size={16} className="text-[#e8753a]" /> روابط مباشرة</span><span className="flex items-center gap-2 text-[#f4efe7]"><Check size={16} className="text-[#e8753a]" /> تصنيف حسب المهمة</span><span className="flex items-center gap-2 text-[#f4efe7]"><Check size={16} className="text-[#e8753a]" /> تجربة عربية RTL</span></div></div></div></section>
    </main>
    <footer className="relative z-10 border-t border-white/10"><div className="mx-auto flex max-w-[1440px] flex-col justify-between gap-4 px-5 py-7 text-xs text-[#77716b] sm:flex-row lg:px-10"><span>دليل الأدوات — ابحث أقل، أنجز أكثر.</span><a href="https://github.com/imim2009im-a11y/digital-insight-ai" target="_blank" rel="noreferrer" className="flex items-center gap-2 transition-colors hover:text-[#e8753a]"><Github size={13} /> مفتوح على GitHub</a></div></footer>
  </div>;
}
